"""
Django settings for 基于深度学习的文案语音图片视频管理分析-视频矩阵系统 project.
...
ROOT_URLCONF = "基于深度学习的文案语音图片视频管理分析-视频矩阵系统.urls"
...
WSGI_APPLICATION = (
    "基于深度学习的文案语音图片视频管理分析-视频矩阵系统.wsgi.application"
)
...
PROJECT_NAME = "基于深度学习的文案语音图片视频管理分析-视频矩阵系统"
DATABASE_NAME = "vm790_bcfe8a202787453d"
